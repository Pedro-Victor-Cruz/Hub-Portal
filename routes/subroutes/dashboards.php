...
use App\Http\Controllers\System\DashboardInvitationController;
use Illuminate\Support\Facades\Route;

Route::prefix('dashboards')->group(function () {

    Route::get('/{key}', [DashboardController::class, 'show']);
    ...
    Route::prefix('invitations')->group(function () {
        // Validar e acessar via convite
        Route::post('{token}/validate', [DashboardInvitationController::class, 'validateToken']);

        // Obter informações do convite (público para preview)
        Route::get('{token}', [DashboardInvitationController::class, 'show']);
    });
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::prefix('invitations')->group(function () {
            Route::put('{token}', [DashboardInvitationController::class, 'update']);

            Route::delete('{token}', [DashboardInvitationController::class, 'destroy']);

            Route::post('{token}/revoke', [DashboardInvitationController::class, 'revoke']);

            Route::get('{token}/stats', [DashboardInvitationController::class, 'stats']);
        });
        ...
        Route::prefix('/{key}')->group(function () {
            ...
            Route::prefix('/invitations')->group(function () {
                ...
                Route::post('/', [DashboardInvitationController::class, 'store']);
            });
